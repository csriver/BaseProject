...
import com.base.pj.databinding.FragmentHomeSubThirdBinding;
...
public class GetherSubFragmentThird extends BaseFragment implements GetherContract.View {
    private FragmentHomeSubThirdBinding binding;
    private GetherPresenter presenter;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        binding=DataBindingUtil.inflate(inflater,R.layout.fragment_home_sub_third, container, false);
        JLog.i("HomeSubFragmentThird","onCreateView");
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        JLog.i("HomeSubFragmentThird","onViewCreated");
    }
